...
class PV:
    ...
    mdel: float | None = None        # bande morte absolue déclarée
    mdel_rel: float | None = None    # bande morte relative déclarée
            ...
            for suffix in KIND_SUFFIXES[kind]:
                pvs.append(
                    PV(
                        ...
                        mdel=signal.get("mdel"),
                        mdel_rel=signal.get("mdel_rel"),
